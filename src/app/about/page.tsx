  ...
  return (
    <article className="max-w-3xl mx-auto">
      ...
      <div className="space-y-8 text-stone-700 leading-relaxed">
        ...
        {/* Human Editing — AI output still needed expert revision */}
        <section>
          <h2 className="text-2xl font-semibold mb-4 text-foreground">
            The Composite Needed Editing, Too
          </h2>
          <p>
            The Ideal Composite was generated by the same AI that scored the
            other versions &mdash; which meant it inherited some of the same
            problems the scorecard was designed to catch. Because it drew on all
            five source documents, including the Client Original, it absorbed
            overconfident claims and unsourced assertions alongside the strong
            material. A careful human edit was required to bring the composite
            to the standard the project demanded.
          </p>
          <p className="mt-4">
            The most significant edits: hedging claims that no published platform
            documentation supports, adding inline source citations so the team
            can verify recommendations themselves, establishing the relationship
            between the young field of generative engine optimization and twenty
            years of SEO best practice, and adding guidance on when to prioritize
            time-sensitive announcements versus evergreen content. The result
            reinforces the core thesis of this project: AI accelerates expert
            work, but it does not replace the expert.
          </p>
        </section>
